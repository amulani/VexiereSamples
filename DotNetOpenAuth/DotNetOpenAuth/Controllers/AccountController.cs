...
using Tavisca.Vexiere.DotNetOpenAuth.VexiereClient.Filters;
using Tavisca.Vexiere.DotNetOpenAuth.VexiereClient.Models;
using System.Configuration;

namespace Tavisca.Vexiere.DotNetOpenAuth.VexiereClient.Controllers
{
    [Authorize]
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.LogOut = "You've successfully Logged out.";
            return View("Login");
        }
